...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Nov 2024 pada 18.06
-- Versi server: 8.1.0
-- Versi PHP: 8.1.17
...
--
-- Struktur dari tabel `pesanan_treatment`
--

CREATE TABLE `pesanan_treatment` (
  `ID_Pesanan` int NOT NULL,
  `Treatment_ID` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Dumping data untuk tabel `pesanan_treatment`
--

INSERT INTO `pesanan_treatment` (`ID_Pesanan`, `Treatment_ID`) VALUES
(1001, 'TM002'),
(1003, 'TM003'),
(1003, 'TM004'),
(1005, 'TM003'),
...
--
-- Indeks untuk tabel `pesanan_treatment`
--
ALTER TABLE `pesanan_treatment`
  ADD KEY `ID_Pesanan` (`ID_Pesanan`,`Treatment_ID`),
  ADD KEY `Treatment_ID` (`Treatment_ID`);
...
--
ALTER TABLE `admin`
  MODIFY `idadmin` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
ALTER TABLE `invoice`
  ...
  ADD CONSTRAINT `invoice_ibfk_3` FOREIGN KEY (`Pembayaran_ID`) REFERENCES `pembayaran` (`Pembayaran_ID`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
--
-- Ketidakleluasaan untuk tabel `pesanan_treatment`
--
ALTER TABLE `pesanan_treatment`
  ADD CONSTRAINT `pesanan_treatment_ibfk_1` FOREIGN KEY (`ID_Pesanan`) REFERENCES `pesanan` (`ID_Pesanan`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `pesanan_treatment_ibfk_2` FOREIGN KEY (`Treatment_ID`) REFERENCES `treatmen` (`Treatment_ID`) ON DELETE RESTRICT ON UPDATE CASCADE;
COMMIT;
